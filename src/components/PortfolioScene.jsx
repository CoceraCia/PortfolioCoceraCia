...
export default function PortfolioScene() {
  ...
  return (
    <>
      <HeroStage resumeCardOpen={resumeCardOpen} onOpenResume={() => setResumeCardOpen(true)} />
      ...
      <SidebarNav
        ...
        onOpenResume={() => setResumeCardOpen(true)}
      />

      <ResumeDialog open={resumeCardOpen} onClose={() => setResumeCardOpen(false)} />
    </>
  );
}
